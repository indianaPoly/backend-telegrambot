export const getLinksByCategory = (category: string) => {
  switch (category) {
    case 'recommand_spelling':
      return [{ text: '맞춤법 검사', url: 'http://speller.cs.pusan.ac.kr/' }];
    ...
    case 'recommand_consulting':
      return [
        {
          text: '인크루트 자소서 무료 컨설팅',
          url: 'https://people.incruit.com/resumeguide/resumeconsulting.asp',
        },
      ];
    default:
      return [];
